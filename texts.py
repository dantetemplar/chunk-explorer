TEXT_PLAIN = """One of the most important things I didn't understand about the world when I was a child is the degree to which the returns for performance are superlinear.
...
TEXT_JS = """import { Document } from "langchain/document";
...
TEXT_PYTHON = r'''from operator import itemgetter
...
TEXT_MARKDOWN = """# Needle In A Haystack - Pressure Testing LLMs
...
<body>
    ...
    <h2>Core Concepts</h2>
    <p>LangChain provides a standard interface for chains, lots of integrations with other tools, and end-to-end chains for common applications.</p>
    
    <h3>Components</h3>
    <p>LangChain consists of several components that work together to create powerful applications.</p>
    
    <h2>Getting Started</h2>
    <p>To get started with LangChain, you'll need to install it and set up your environment.</p>
    
    <h3>Installation</h3>
    <p>Install LangChain using pip: <code>pip install langchain</code></p>
    
    <h2>Examples</h2>
    <p>Here are some examples of what you can build with LangChain.</p>
    
    <h3>Simple Chain</h3>
    <p>A simple chain that takes user input and processes it through a language model.</p>
    
    <h2>Advanced Topics</h2>
    <p>Learn about more advanced features and concepts in LangChain.</p>
    
    <h3>Memory</h3>
    <p>How to add memory to your chains to maintain context between calls.</p>
    
    <h3>Agents</h3>
    <p>How to use agents to dynamically call tools based on user input.</p>
</body>
</html>
"""
